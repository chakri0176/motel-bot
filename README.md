...
```
.
├── server.py          # Main FastAPI application with WebSocket endpoint
├── tools.py           # LangChain tools for room operations
...
```
ws://localhost:8000/llm-websocket/{call_id}
```
...
```json
{
  ...
  "response_id": 1,
  "content": "I'd be happy to help you book a room. What type would you prefer: Queen, King, or Suite?",
...
**Parameters:**
- `room_type` (str): Room type to check (Queen, King, Suite)
...
**Note:** This is a beta version under active development. Breaking changes may occur between updates. Please check the changelog before upgrading.